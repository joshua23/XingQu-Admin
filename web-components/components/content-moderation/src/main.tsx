...
function setupFeishuMessaging() {
  ...
  window.parent.postMessage({
    ...
    componentType: 'content_moderation',
    data: {
...
window.addEventListener('error', (event) => {
  console.error('Content moderation component error:', event.error);
...
window.addEventListener('load', () => {
  ...
  console.log(`Content moderation component loaded in ${loadTime.toFixed(2)}ms`);
